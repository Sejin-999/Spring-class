...
public class MockMemberServcie implements MemberService {
    ...
    public void init() {
		...
		vo.setDepart("computer"); vo.setMobile("010-2222-3333"); vo.setEmail("kang@tukorea.ac.kr");
		
		StudentVO vo2 = new StudentVO(); 
		vo2.setId("han"); vo2.setPasswd("passwd");  vo2.setUsername("hanjo"); vo2.setSnum("20201042");
		vo2.setDepart("computer"); vo2.setMobile("010-7777-1111"); vo2.setEmail("han@tukorea.ac.kr");
